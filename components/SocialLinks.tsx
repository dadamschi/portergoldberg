...
export function FacebookIcon({ size = 56, mono = false }: IconProps) {
  if (mono) {
    return (
...
export function InstagramIcon({ size = 56, mono = false }: IconProps) {
  if (mono) {
    return (
      <svg viewBox="0 0 24 24" width={size} height={size} fill="currentColor">
...
export function YouTubeIcon({ size = 56, mono = false }: IconProps) {
  if (mono) {
    return (
      <svg viewBox="0 0 24 24" width={size} height={size} fill="currentColor">
...
export const SOCIAL_URLS = {
  ...
  youtube: 'https://www.youtube.com/@PorterGoldbergResidential',
}
